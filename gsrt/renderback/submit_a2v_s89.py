...
wf["7"] = n(7, "MiniMaxH3SigmaShift", model=["6", 0], shift_video=12.0, shift_audio=3.0)[1]
# LightX2V 8-step (生产档) — bypass 到 SigmaShift 输出
wf["17"] = n(17, "LoraLoaderModelOnly",
             model=["7", 0],
             lora_name="minimax_h3_fl2v_turbo_8step_v1.0_768p_comfyui_bf16.safetensors",
             strength_model=16.0)[1]
...
wf["8"] = n(8, "MiniMaxH3AudioConditioningT8",
               ...
               first_frame=["18", 0],
               last_frame=["19", 0],
               prompt="3D animation, Pixar-level rendering, cinematic shallow depth of field. "
                      "Primeval forest, moss-covered fallen logs, towering trees. "
                      "A green mantis warrior slowly draws a bamboo katana from its scabbard while "
                      "an orange fuzzy caterpillar child in the far background covers its eyes with both paws, "
                      "counting numbers aloud, fully diegetic sound, no other speech, "
                      "no scored music, strictly diegetic in-world sound, unscored scene. "
...
wf["10"] = n(10, "BasicGuider", model=["17", 0], conditioning=["8", 0])[1]
wf["11"] = n(11, "KSamplerSelect", sampler_name="res_multistep")[1]
wf["12"] = n(12, "BasicScheduler", model=["17", 0], scheduler="simple", steps=9, denoise=1.0)[1]
...
wf["16"] = n(16, "VHS_VideoCombine", images=["15", 0], audio=["15", 1],
                ...
                filename_prefix="gsrt_a2v_s89_v1",
